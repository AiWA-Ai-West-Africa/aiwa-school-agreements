...
We are writing to let you know about a special activity for students in the **AIWA [PROGRAM_NAME]** at **[SCHOOL_NAME]**.
...
**Where are we going?**
[TRIP_DESTINATION]
[TRIP_DESTINATION_ADDRESS]

**When is it?**
Date: [TRIP_DATE]
Leave school at: [DEPARTURE_TIME]
Return to school by: [RETURN_TIME]
...
There will be at least one supervisor for every [SUPERVISOR_RATIO] students throughout the activity.
...
- I give permission for my child to travel to **[TRIP_DESTINATION]** on **[TRIP_DATE]** using the arrangements described above.
- I agree to ensure my child arrives at school by **[DEPARTURE_TIME]** on the day.
- I will collect my child from school (or arrange collection) by **[RETURN_TIME]**, or as notified if there is a delay.
