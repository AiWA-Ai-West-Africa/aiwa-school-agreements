...
1.1 AI West Africa (AIWA) is an educational and publishing initiative dedicated to advancing
literacy development, educational publishing, and contributor development in The Gambia
and the West African region.

1.2 [SCHOOL_NAME] is a registered educational institution operating within the jurisdiction
...
2.1 The programme to be delivered under this Agreement is:
...
2.3 A curriculum overview is attached as **Schedule B** to this Agreement.

---

## 3. Obligations of AIWA
...
3.3 Obtain written consent from parents or guardians of all participating students before
programme activities commence, using the approved AIWA consent forms.
...
4.1 Provide appropriate facilities — including classroom space, seating, and access to materials —
...
6.4 Nothing in this Agreement grants either party rights over the other's pre-existing materials
...
7.1 This Agreement commences on [CONTRACT_START_DATE] and expires on [CONTRACT_END_DATE],
unless earlier terminated in accordance with this clause.

7.2 Either party may terminate this Agreement by giving [NOTICE_PERIOD] written notice to
the other party.

7.3 Either party may terminate this Agreement immediately if:
- (a) a serious safeguarding concern arises that cannot be adequately addressed; or
- (b) the other party is in material breach of this Agreement and has failed to remedy
  that breach within 14 days of written notice.

7.4 Termination does not affect the rights and obligations of the parties that have already
...
*To be completed and attached for each specific school partnership.*
...
## Schedule B — Curriculum Overview
