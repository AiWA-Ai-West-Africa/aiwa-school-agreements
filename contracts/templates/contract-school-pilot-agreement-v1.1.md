...
[SCHOOL_NAME]
[SCHOOL_ADDRESS]
[SCHOOL_REGION], The Republic of The Gambia
("The School")
...
**C.** AIWA has developed the **[PROGRAM_NAME]** (the "Programme"), an educational initiative
...
**"Programme"** means the [PROGRAM_NAME], as described in Clause 3 and detailed in Schedule B.
...
4.3 The detailed session schedule for the [ACADEMIC_YEAR] academic year is attached as
...
16.1 Either party may terminate this Agreement by giving **[NOTICE_PERIOD]** written
...
this Agreement for a further academic year. [RENEWAL_TERMS].
...
notice by either party, the dispute shall be referred to [DISPUTE_RESOLUTION].
...
[AIWA_REPRESENTATIVE_NAME], [AIWA_REPRESENTATIVE_TITLE]
Email: [AIWA_CONTACT_EMAIL] | Phone: [AIWA_CONTACT_PHONE]

20.3 The School's designated contact for notices:
[PRINCIPAL_NAME], [PRINCIPAL_TITLE]
Email: [SCHOOL_CONTACT_EMAIL] | Phone: [SCHOOL_CONTACT_PHONE]
...
Title: [AIWA_REPRESENTATIVE_TITLE]
...
Title: Principal / [PRINCIPAL_TITLE]
...
*Complete in accordance with [PLACEHOLDER-CONVENTION.md](../../PLACEHOLDER-CONVENTION.md) session placeholders.*
...
|---|---|---|---|---|
| [SESSION_NUMBER] | [SESSION_DATE] | [SESSION_TIME] | [SESSION_LOCATION] | [SESSION_TOPIC] |
| [SESSION_NUMBER] | [SESSION_DATE] | [SESSION_TIME] | [SESSION_LOCATION] | [SESSION_TOPIC] |
| [SESSION_NUMBER] | [SESSION_DATE] | [SESSION_TIME] | [SESSION_LOCATION] | [SESSION_TOPIC] |
| ... | | | | |
