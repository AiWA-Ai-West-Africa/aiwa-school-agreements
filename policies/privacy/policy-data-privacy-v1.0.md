...
## AIWA DATA PRIVACY AND INFORMATION GOVERNANCE POLICY
...
- Shared with organisations outside AIWA without explicit consent (except as required by law)

---

## 4. Data Security

AIWA takes reasonable steps to protect personal information from unauthorised access,
loss, or misuse. Executed documents containing personal information are held in restricted
access storage and are not shared publicly.
...
- Withdraw consent for use of information in future communications or publications

Requests should be sent to: [AIWA_CONTACT_EMAIL]

---

## 7. Third Party Processing

Where AIWA shares information with third parties (e.g., printing partners for publications),
appropriate data protection commitments will be in place.

---

## 8. Review

This policy will be reviewed annually or upon any change to applicable Gambian legislation.
